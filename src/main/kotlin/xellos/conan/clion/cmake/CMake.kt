package xellos.conan.clion.cmake
...
class CMake(val project: Project) {
    ...
    fun injectConanSupportToProfile(profileName: String) {
        ...
        val conanProviderPath = project.service<ConanService>().getCMakeProviderFile().absolutePath
        ...
        if (project.service<PropertiesComponent>()
            ...
            if (isCMakeParallel) {
                ...
                NotificationGroupManager.getInstance()
                    .getNotificationGroup("xellos.conan.clion.notifications.general")
                    .createNotification(
