package xellos.conan.clion.services
...
import java.io.File
import xellos.conan.clion.cmake.CMake
import xellos.conan.clion.conan.ConanPluginUtils
import xellos.conan.clion.conan.extensions.downloadFromUrl
import xellos.conan.clion.models.LibraryData
import xellos.conan.clion.models.PersistentStorageKeys
...
class ConanService(val project: Project) {
    ...
    fun getCMakeProviderFile(): File {
        return File(ConanPluginUtils.getPluginHome(), getCMakeProviderFilename())
    }
